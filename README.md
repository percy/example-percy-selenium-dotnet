...
> **New:** This repo ships an [`advanced/`](./advanced) example covering the full applicable Percy SDK feature surface for `PercyIO.Selenium`. See the [Percy SDK Feature Matrix](https://docs.percy.io/docs/sdk-feature-matrix) for cross-SDK coverage.
...
| [`./advanced/`](./advanced) | Full applicable Percy SDK feature surface: widths, minHeight, enableJavaScript, readiness, responsiveSnapshotCapture, regions, sync, Dictionary vs anonymous-object overloads. xUnit-driven. See [`advanced/README.md`](./advanced/README.md) for the matrix-row coverage table. | `cd advanced && make test` |
